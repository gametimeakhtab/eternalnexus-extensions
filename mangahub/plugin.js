...
class Provider {
    ...
    async function getHome(cb) {
      try {
        ...
        cb({ success: true, data: { "Latest": [new MultimediaItem({ title: "MangaHub", url: manifest.baseUrl, posterUrl: "./icon.png", type: manifest.type })] } });
    ...
    async function load(url, cb) {
      try {
        ...
        cb({ success: true, data: new MultimediaItem({ title: "MangaHub", url, type: manifest.type }) });
      } catch (e) { cb({ success: false, message: String(e) }); }
    }
