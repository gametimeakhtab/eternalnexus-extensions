(function() {
    var manifest = {"packageName":"com.eternalnexus.dev_akash_stars_4khd","name":"4K HD","version":1,"description":"4K Movies and TV Shows (VOD)","author":"eternalnexus","authors":["eternalnexus"],"baseUrl":"https://4khdhub.link","type":"video","rating":"All","isAdult":false,"language":"en","languages":["en"],"icon":"icon.png","iconUrl":"./icon.png","manifestVersion":1};
(function() {
    /**
    ...
    async function getHome(cb) {
      try {
        ...
        cb({ success: true, data: { "Latest": [new MultimediaItem({ title: "4K HD", url: manifest.baseUrl, posterUrl: "./icon.png", type: manifest.type })] } });
    ...
    async function load(url, cb) {
      try {
        ...
        cb({ success: true, data: new MultimediaItem({ title: "4K HD", url, type: manifest.type }) });
      } catch (e) { cb({ success: false, message: String(e) }); }
    }
