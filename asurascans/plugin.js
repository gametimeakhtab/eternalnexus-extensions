  ...
  _astroVal(encoded) {
    ...
    async function getHome(cb) {
      try {
        ...
        cb({ success: true, data: { "Latest": [new MultimediaItem({ title: "AsuraScans", url: manifest.baseUrl, posterUrl: "./icon.png", type: manifest.type })] } });
    ...
    async function load(url, cb) {
      try {
        ...
        cb({ success: true, data: new MultimediaItem({ title: "AsuraScans", url, type: manifest.type }) });
      } catch (e) { cb({ success: false, message: String(e) }); }
    }
