(function() {
    var manifest = {"packageName":"com.eternalnexus.dev_akash_stars_moviesdrive","name":"Movies Drive","version":1,"description":"Premium VOD Scraper with metadata sync","author":"eternalnexus","authors":["eternalnexus"],"baseUrl":"https://new2.moviesdrives.my","type":"video","rating":"All","isAdult":false,"language":"en","languages":["en"],"icon":"icon.png","iconUrl":"./icon.png","manifestVersion":1};
(function() {
    /**
    ...
    async function getHome(cb) {
      try {
        ...
        cb({ success: true, data: { "Latest": [new MultimediaItem({ title: "Movies Drive", url: manifest.baseUrl, posterUrl: "./icon.png", type: manifest.type })] } });
    ...
    async function load(url, cb) {
      try {
        ...
        cb({ success: true, data: new MultimediaItem({ title: "Movies Drive", url, type: manifest.type }) });
      } catch (e) { cb({ success: false, message: String(e) }); }
    }
