(function() {
    var manifest = {"packageName":"com.eternalnexus.dev_akash_stars_hdhub4u","name":"HDHub4U","version":1,"description":"Bollywood, Hollywood and Hindi Dubbed Movies & Web Series","author":"eternalnexus","authors":["eternalnexus"],"baseUrl":"https://new2.hdhub4u.limo","type":"video","rating":"All","isAdult":false,"language":"en","languages":["en"],"icon":"icon.png","iconUrl":"./icon.png","manifestVersion":1};
(function() {
    ...
    async function getHome(cb) {
      try {
        ...
        cb({ success: true, data: { "Latest": [new MultimediaItem({ title: "HDHub4U", url: manifest.baseUrl, posterUrl: "./icon.png", type: manifest.type })] } });
    ...
    async function load(url, cb) {
      try {
        ...
        cb({ success: true, data: new MultimediaItem({ title: "HDHub4U", url, type: manifest.type }) });
      } catch (e) { cb({ success: false, message: String(e) }); }
    }
